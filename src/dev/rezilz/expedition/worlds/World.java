package dev.rezilz.expedition.worlds;

import java.awt.Graphics;

import dev.rezilz.expedition.Game;
import dev.rezilz.expedition.Handler;
import dev.rezilz.expedition.entities.EntityManager;
...
import dev.rezilz.expedition.utils.Utils;
...
public class World {
	...
	private void loadWorld(String path){
		...
		String[] tokens = file.split("\\s+"); //pass the space to string
